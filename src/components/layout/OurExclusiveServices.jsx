                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="py-[18px] px-2 flex flex-col bg-[#E9F9FC] rounded-2xl">
                        ...
                        <button className='mt-3 w-fit bg-[#FFFFFF] rounded-2xl flex gap-0.5 items-center py-2 px-2 border text-[#FF1E1E] font-semibold text-[12px] leading-[150%] '>
                            <p>Watch Video</p>
                            <img src="/images/PlayBTN.png" alt="Play" className="" />
                        </button>
                    </div>
                    ...
                    <div className="py-[18px] px-2 flex flex-col bg-[#FDF2F2] rounded-2xl">
                        ...
                        <p className='text-[14px] text-[#605F62] leading-[150%] h-[125px]'>Our mentors help you create and manage freelancing accounts, build your portfolio, communicate with clients, and start earning confidently online.</p>
                        <button className='mt-3 w-fit bg-[#FFFFFF] rounded-2xl flex gap-0.5 items-center py-2 px-2 border text-[#FF1E1E] font-semibold text-[12px] leading-[150%] '>
                            <p>Watch Video</p>
                            <img src="/images/PlayBTN.png" alt="Play" className="" />
                        </button>
