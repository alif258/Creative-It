  ...
  <Container>
    <Flex className="flex-col md:flex-row gap-6">
      ...
      <div className="right w-full md:w-1/2 mt-6 md:mt-0 flex flex-col items-center">
        ...
        <div className="btn mt-4 flex flex-col sm:flex-row gap-3 w-full justify-center">
          <button className="font-semibold border text-[#E73327] text-[16px] flex justify-center py-4 px-6 sm:px-10 rounded-2xl w-full sm:w-auto">
            Join Free Class
          </button>
          <button className="font-semibold text-white text-[16px] flex justify-center py-4 px-6 sm:px-10 bg-gradient-to-r from-[#FF1E1E] to-[#FF5E5E] rounded-2xl w-full sm:w-auto">
            Get Admission
          </button>
        </div>
      </div>
